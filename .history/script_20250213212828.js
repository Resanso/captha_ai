  ...
  try {
    const response = await fetch(API_URL, {
      ...
      headers: {
        ...
        Authorization:
          "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",
      },
      body: JSON.stringify({
        model: "gpt-3.5-turbo",
        messages: [
